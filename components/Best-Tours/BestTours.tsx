...
export default function Besttours({ packages }: packagePropsTypeForDomestic) {
  ...
  return (
    <>
      ...
      <div className="w-full h-auto overflow-x-hidden">
        <div>
          <Cards data={packages.slice(currentDestinationIndex, currentDestinationIndex + cardsToShow)} />
        </div>
