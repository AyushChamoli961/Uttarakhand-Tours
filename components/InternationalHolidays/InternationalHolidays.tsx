...
import AllInternationalHolidays from "./AllInternationalHolidays";
import { packagePropsTypeForDomestic } from "@/utils/pacakageTypes";

export default function InternationalHolidays({ packages }: packagePropsTypeForDomestic) {
  ...
  return (
    <div className="mb-8 mt-3">
      ...
      <div className="w-full h-auto overflow-x-hidden">
        <div>
          <AllInternationalHolidays data={packages.slice(currentDestinationIndex, currentDestinationIndex + cardsToShow)} />
        </div>
