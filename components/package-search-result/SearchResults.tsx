...
export default function SearchResult({ packages, clearFilters }: { packages: any[], clearFilters: () => void }) {
    ...
    <div className="mb-8 mt-6">
      <div className="w-full flex flex-col items-center mt-4">
        <div className="flex items-center justify-center w-full mb-4">
          ...
          <button
        className="hover:bg-[#ff4d4d] transition-colors duration-200 px-6 py-2 rounded-lg bg-[#ff3333] text-white"
